...
public class SoundeManager : MonoBehaviour
{
    ...
    private static SoundeManager instance;
    public static SoundeManager Instance
    {
        get
        {
            if (instance == null)
            {
                var gameObject = new GameObject("SoundeManager");
                DontDestroyOnLoad(gameObject);

                instance = gameObject.AddComponent<SoundeManager>();
